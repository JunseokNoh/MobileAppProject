...
public class choice_course_fragment extends Fragment {
    ...
    private MaterialTextView Restaurant;
    private MaterialTextView Coffee;
    private MaterialTextView Play;
    private MaterialTextView LookThings;
    ...
    public static choice_course_fragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MaterialTextView Restaurant = v.findViewById(R.id.restaurant);
        MaterialTextView Coffee = v.findViewById(R.id.coffee);
        MaterialTextView Play = v.findViewById(R.id.play);
        MaterialTextView LookThings = v.findViewById(R.id.lookThings);
